    ...
    <section className="w-full bg-[#F4F6F5] dark:bg-[#0D120F] py-16 lg:py-24 transition-colors duration-300 overflow-hidden">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-8">
        ...
        <div className="w-full">
          <Swiper
            loop={true}
            speed={4000} // Суръати гузариш ба миллисония
            autoplay={{
              delay: 0, // Бе пауза ва таваққуф
              disableOnInteraction: false,
              pauseOnMouseEnter: false, // Агар хоҳӣ вақти сипери муш ҳам наистад
            }}
            freeMode={true}
            grabCursor={true}
            spaceBetween={20}
            ...
            className="w-full mySwiper [&_.swiper-wrapper]:ease-linear" // CSS class барои ҳаракати мулоим (Linear timing)
          >
