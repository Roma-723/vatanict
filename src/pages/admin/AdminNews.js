                                ...
                                <Grid container spacing={0}>
                                    <Grid item lg='12' md='12' sm='12' xs='12' sx={languageInput != 1 ? {display:'none'} : {}}>
                                        <div className=''>
                                            <div className='style_editor'>
                                                ...
                                                <input name='name_tj' className='w-full p-[16px] border-[1px] mdMUI:text-[18px] text-[14px] mdMUI:leading-[21.94px] leading-[17.07px] border-[rgba(123,123,123,1)] mdMUI:mb-[24px] mb-[8px] rounded-[100px]' placeholder='name_tj'/>
                                    ...
                                    <Grid item lg='12' md='12' sm='12' xs='12' sx={languageInput != 2 ? {display:'none'} : {}}>
                                        <div className=''>
                                            <div className=''>
                                                <label className='mdMUI:text-[24px] text-[16px] font-[600] ml-[20px]'>Нозвание проекта</label>
                                                <input name='name_ru' className='w-full p-[16px] border-[1px] mdMUI:text-[18px] text-[14px] mdMUI:leading-[21.94px] leading-[17.07px] border-[rgba(123,123,123,1)] mdMUI:mb-[24px] mb-[8px] rounded-[100px]' placeholder='name_ru'/>
                                                <label className='mdMUI:text-[24px] text-[16px] font-[600] ml-[20px]'>Заголовак</label>
                                    ...
                                    <Grid item lg='12' md='12' sm='12' xs='12' sx={languageInput != 3 ? {display:'none'} : {}}>
                                        <div className=''>
                                            <div className=''>
                                                <label className='mdMUI:text-[24px] text-[16px] font-[600] ml-[20px]'>Нозвание проекта</label>
                                                <input name='name_en' className='w-full p-[16px] border-[1px] mdMUI:text-[18px] text-[14px] mdMUI:leading-[21.94px] leading-[17.07px] border-[rgba(123,123,123,1)] mdMUI:mb-[24px] mb-[8px] rounded-[100px]' placeholder='name_en'/>
                                                <label className='mdMUI:text-[24px] text-[16px] font-[600] ml-[20px]'>Заголовак</label>
                        ...
                        <Grid item lg='6' md='6' sm='12' xs='12'>
                            <div className='w-full'>
                                <Grid container spacing={3}>
                                    ...
                                    <Grid item lg='12' md='12' sm='12' xs='12'>
                                        <div className=''>
                                          <label className='mdMUI:text-[24px] text-[16px] font-[600] ml-[20px]'>Дата</label>
                                          <input name='year' type='month' className='w-full p-[16px] border-[1px] mdMUI:text-[18px] text-[14px] mdMUI:leading-[21.94px] leading-[17.07px] border-[rgba(123,123,123,1)] mdMUI:mb-[24px] mb-[8px] rounded-[100px]'/>
                                        </div>
                                    </Grid>
                                </Grid>
                            </div>
