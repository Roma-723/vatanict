...
function Projects() {
  ...
  return (
    <div className="w-full bg-[rgba(242,242,242,1)] 2xl:min-h-[80.8vh] mdMUI:pt-[192px] pt-[36px] mdMUI:pb-[150px] pb-[120px]">
      <Helmet>
        <title>Vatan ICT</title>
        <meta
          name="description"
          content='"Цифровые технологии на службе общества" и на глубокие знания своих сотрудников, компания в настоящий момент продолжает развивать собственные бизнес продукты и реализовывать проекты по цифровизации процессов для своих заказчиков.'
        />
      </Helmet>
      <div className="">
          ...
          >
            {career_state === 1 ? (
              ...
              >
                <div className="mdMUI:mr-[10px] mr-[4px] mdMUI:w-[24px] mdMUI:h-[24px] w-[16px] h-[16px]">
                  <img src={icon_all_white} alt="icon_all_white" width="100%" />
                </div>
                {/* Все */}
                {t("project.text1")}
              </button>
              ...
              <div className="button_project">
                ...
                >
                  <div className="mdMUI:mr-[10px] mr-[4px] mdMUI:w-[24px] mdMUI:h-[24px] w-[16px] h-[16px]">
                    <img src={icon_all} alt="icon_all" width="100%" />
                  </div>
                  {/* Все */}
                  {t("project.text1")}
                </button>
            ...
            {career_state === 2 ? (
              ...
              <div className="button_project">
                ...
                >
                  <div className="mdMUI:mr-[10px] mr-[4px] mdMUI:w-[24px] mdMUI:h-[24px] w-[16px] h-[16px]">
                    <img src={icon_shield} alt="icon_shield" width="100%" />
                  </div>
                  {/* Госсектор */}
                  ...
                  >
                    <div className="project_card_hovet w-full lgMUI:min-h-[439px] mdMUI:min-h-[505px] min-h-[470px] bg-white rounded-[16px]">
                      <div className="">
                        <img
                          src={e.image}
                          alt={"projectCardsFilter " + e.id}
                          className="w-full my-auto rounded-t-[16px]"
                        />
                      </div>
